...
def parse_opts():
    ...
    parser.add_argument(
        "--show_real_imgs", action="store_true", default=False
    )  # output a grid of real images for all 300 unique cell counts
    ...
    parser.add_argument(
        "--epoch_cnn_embed", type=int, default=400
    ...
    parser.add_argument(
        "--niters_gan", type=int, default=10000, help="number of iterations"
    )
    ...
    parser.add_argument(
        "--lr_g_gan", type=float, default=1e-4, help="learning rate for generator"
    )
    parser.add_argument(
        "--lr_d_gan", type=float, default=1e-4, help="learning rate for discriminator"
    )
    parser.add_argument(
        "--dim_gan", type=int, default=128, help="Latent dimension of GAN"
    )
    ...
    parser.add_argument(
        "--cGAN_num_classes", type=int, default=20, metavar="N"
    )  # bin label into cGAN_num_classes
